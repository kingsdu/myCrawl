...
//          System.out.println(this.getNodeValue() + " : compsosite importance : " + this.getCompositeImportance());
    ...
    public void getInformation() {
        ...
        System.out.println("[NODE] " + "  this.getNodeName()------  " + this.getNodeName() + "   this.getNodeValue()------   " + this.getNodeValue() + "   this.children.size()------   " + this.children.size() + "   this.contents.size()------   " + this.contents.size() + "   strContents------   " + strContents);
//        return "[NODE] " + "this.getNodeName()------" + this.getNodeName() + "this.getNodeValue()------" + this.getNodeValue() + "this.children.size()------" + this.children.size() + "this.contents.size()------" + this.contents.size() + "strContents------" + strContents;
}
