...
public class StyleNode {
    ...
    public void getInformation() {
            ...
            System.out.println("[NODE--SET] " + "  childrenInfo   " +childrenInfo + "  this.nodeList.size()  " + this.nodeList.size() + "  count  " + count);
//            return "[NODE--SET] " + childrenInfo + " " + this.nodeList.size() + " " + count;
    }
