...
public class Berkeley_DB {
	...
	//数据库文件名
	private  String fileName = "E:\\test\\hetritrix\\Berkeley_DB";
	//数据库名称
	private  String dbName = "my_DB01";
	...
	public  void closeDatabase() {  
		...
		{
			System.out.println("关闭数据库: " + dbName);
		...
		try {
			...
			try
			{
				...
				if(res == OperationStatus.SUCCESS)
				{
					...
					System.out.println("从数据库" + dbName +"中读取:"+key+","+foundData);
					return foundData;
				}
				else
				{
